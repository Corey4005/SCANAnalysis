...
sms['2in_rolling_mean'] = sms['SMS-2.0in'].rolling(7, min_periods=7).mean()
sms['4in_rolling_mean'] = sms['SMS-4.0in'].rolling(7, min_periods=7).mean()
sms['8in_rolling_mean'] = sms['SMS-8.0in'].rolling(7, min_periods=7).mean()
sms['20in_rolling_mean'] = sms['SMS-20.0in'].rolling(7, min_periods=7).mean()
sms['40in_rolling_mean'] = sms['SMS-40.0in'].rolling(7, min_periods=7).mean()
